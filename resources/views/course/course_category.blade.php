                                ...
                                <x-actions>
                                    ...
                                    <li class="navi-item">
                                        <a href="javascript:;" class="navi-link" data-toggle="modal" data-target="#ediModal" onclick="ediFn(this)"
                                           data-href="{{route('subject-category.update', ['subject_category' => $row->id])}}"
                                           data-name="{{$row->name}}"
                                        >
                                    ...
                                    <li class="navi-item">
                                        <a href="javascript:;" data-href="{{route('subject-category.destroy', ['subject_category' => $row->id])}}" class="navi-link" onclick="delFn(this)">

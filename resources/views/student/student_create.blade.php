    ...
    <div class="row">
        <div class="col">
            <x-card label="{{__('New Student Registration')}}">
                ...
                <form id="studenRegistrationForm" action="{{route('student.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div style="overflow:auto;" id="nextprevious">
                        <div style="float:right;">
                            <button class="btn btn-warning" type="button" id="prevBtn" onclick="nextPrev(-1)"><i class="fa fa-arrow-alt-circle-left"></i> Previous</button>
                            <button class="btn btn-success" type="button" id="nextBtn" onclick="nextPrev(1)">Next <i class="fa fa-arrow-alt-circle-right"></i></button>

                            <button class="btn btn-success" type="submit" id="submitBtn">Save  <i class="fa fa-check"></i></button>
                        </div>
                    </div>
...
@section('style')
   <link href="{{asset('assets/css/pages/form/multistep-form.css')}}" rel="stylesheet" type="text/css" />
{{--    <link href="{{asset('assets/css/pages/wizard/wizard-2.css')}}" rel="stylesheet" type="text/css" />--}}
@endsection


@section('script')
   <script src="{{asset('assets/js/pages/custom/form/multi-step-from.js')}}"></script>
